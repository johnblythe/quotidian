...
1. Read the PRD at `scripts/ralph-beta/prd.json`
2. Read the progress log at `scripts/ralph-beta/progress.txt` (check Codebase Patterns section first)
...
9. Append your progress to `scripts/ralph-beta/progress.txt`

## Progress Report Format

APPEND to scripts/ralph-beta/progress.txt (never replace, always append):
```

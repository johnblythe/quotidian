...
1. Read the PRD at `scripts/ralph-v2/prd.json`
2. Read the progress log at `scripts/ralph-v2/progress.txt` (check Codebase Patterns section first)
...
9. Append your progress to `scripts/ralph-v2/progress.txt`

## Progress Report Format

APPEND to scripts/ralph-v2/progress.txt (never replace, always append):
```
